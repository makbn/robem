...
"""
@ref: https://github.com/megagonlabs/ditto
"""
...
class Augmenter(object):
    ...
    def augment(self, tokens, labels, op='del'):
        ...
        if 'del' in op:
            ...
            col_starts = [i for i in range(len(tokens)) if tokens[i] == 'ATTR']
...
if __name__ == '__main__':
    ...
    print(text)
    for op in ['all', 'all', 'all', 'all', 'all', 'all', 'all', 'all', 'all', 'all', 'all', 'all']:
        print(op)
